...
> 📖 **Guía completa en el blog:** [OpenAI Privacy Filter: el modelo open-source gratuito que enmascara datos personales offline (GPU y CPU)](https://pasqualepillitteri.it/es/news/1353/openai-privacy-filter-enmascarado-datos-offline-gpu-cpu)

> 📦 **Artículo dedicado a esta herramienta:** [Claude Privacy Tool: la herramienta gratuita que enmascara los datos personales antes de Claude (Python + JavaScript)](https://pasqualepillitteri.it/es/news/1363/claude-privacy-tool-hook-privacidad-claude-code-desktop)
...
<p align="center">
  <img src="claude-privacy-tool-example.png" alt="Claude Privacy Tool ejemplo real en Claude Code - nombre reemplazado por placeholder" width="100%">
</p>

El nombre "Pasquale Pillitteri" es reemplazado por `[PRIVATE_PERSON_1]` antes de que el prompt llegue a Claude. La respuesta vuelve con el valor real gracias a la desanonimización local.
...
1. Usa el Node.js de tu sistema (sin venv, sin compilación)
...
Artículo de referencia: [Guía OpenAI Privacy Filter](https://pasqualepillitteri.it/es/news/1353/openai-privacy-filter-enmascarado-datos-offline-gpu-cpu)
